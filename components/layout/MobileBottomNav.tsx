                        ...
                        {mobileNavItems.map((item) => {
                            ...
                            return (
                                <a
                                    ...
                                    className="relative flex flex-col items-center justify-center gap-1 flex-shrink-0 w-[14.28%] min-w-[14.28%] h-full transition-colors duration-200 active:scale-95"
                                    style={{
