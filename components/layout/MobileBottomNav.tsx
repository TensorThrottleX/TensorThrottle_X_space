                        ...
                        {mobileNavItems.map((item) => {
                            ...
                            return (
                                <a
                                    ...
                                    className="relative flex flex-col items-center justify-center gap-1 flex-shrink-0 w-[72px] min-w-[72px] h-full transition-colors duration-200 active:scale-95"
                                    style={{
