      ...
      <ContentPanel title="About" subtitle="This experimental portfolio">
        <article className="space-y-8">
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Design Philosophy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Three Visual Layers</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Navigation Controls</h2>
            <p className="leading-relaxed transition-colors duration-500" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Content Presentation</h2>
            <p className="leading-relaxed transition-colors duration-500" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Technical Foundation</h2>
            <p className="leading-relaxed transition-colors duration-500" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-bold transition-colors duration-500" style={{ color: 'var(--foreground)' }}>Design Tone</h2>
            <p className="leading-relaxed transition-colors duration-500" style={{ color: 'var(--text-secondary)' }}>
